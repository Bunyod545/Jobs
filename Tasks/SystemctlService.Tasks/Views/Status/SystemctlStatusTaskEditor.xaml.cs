...
namespace SystemctlService.Tasks.Views
{
    ...
    public partial class SystemctlStatusTaskEditor
    {
        ...
        /// 
        /// </summary>
        public SystemctStatuslTaskEditorModel ViewModel { get; private set; }
        ...
        {
            ViewModel = GetTaskData<SystemctStatuslTaskEditorModel>() ?? new SystemctStatuslTaskEditorModel();
